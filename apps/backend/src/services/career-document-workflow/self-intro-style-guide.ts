...
export function buildSocraticDraftingRules() {
  return [
    ...
    "Unless an attached document or user instruction gives a smaller limit, target a DOCX-ready one-page cover-letter body of about 900-1200 Korean characters and do not exceed about 1500 characters.",
